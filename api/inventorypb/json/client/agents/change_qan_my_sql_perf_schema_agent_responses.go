...
const (
	...
	// ChangeQANMySQLPerfSchemaAgentOKBodyQANMysqlPerfschemaAgentStatusINITILIZATIONERROR captures enum value "INITILIZATION_ERROR"
	ChangeQANMySQLPerfSchemaAgentOKBodyQANMysqlPerfschemaAgentStatusINITILIZATIONERROR string = "INITILIZATION_ERROR"
)
