...
const (
	...
	// AddMongoDBExporterOKBodyMongodbExporterStatusINITILIZATIONERROR captures enum value "INITILIZATION_ERROR"
	AddMongoDBExporterOKBodyMongodbExporterStatusINITILIZATIONERROR string = "INITILIZATION_ERROR"
)
