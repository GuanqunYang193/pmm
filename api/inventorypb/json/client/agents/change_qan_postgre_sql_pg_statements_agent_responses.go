...
const (
	...
	// ChangeQANPostgreSQLPgStatementsAgentOKBodyQANPostgresqlPgstatementsAgentStatusINITILIZATIONERROR captures enum value "INITILIZATION_ERROR"
	ChangeQANPostgreSQLPgStatementsAgentOKBodyQANPostgresqlPgstatementsAgentStatusINITILIZATIONERROR string = "INITILIZATION_ERROR"
)
