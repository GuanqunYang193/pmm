...
const (
	...
	// ChangeQANMongoDBProfilerAgentOKBodyQANMongodbProfilerAgentStatusINITILIZATIONERROR captures enum value "INITILIZATION_ERROR"
	ChangeQANMongoDBProfilerAgentOKBodyQANMongodbProfilerAgentStatusINITILIZATIONERROR string = "INITILIZATION_ERROR"
)
