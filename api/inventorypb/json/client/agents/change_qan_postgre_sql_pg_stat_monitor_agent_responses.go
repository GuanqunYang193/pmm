...
const (
	...
	// ChangeQANPostgreSQLPgStatMonitorAgentOKBodyQANPostgresqlPgstatmonitorAgentStatusINITILIZATIONERROR captures enum value "INITILIZATION_ERROR"
	ChangeQANPostgreSQLPgStatMonitorAgentOKBodyQANPostgresqlPgstatmonitorAgentStatusINITILIZATIONERROR string = "INITILIZATION_ERROR"
)
