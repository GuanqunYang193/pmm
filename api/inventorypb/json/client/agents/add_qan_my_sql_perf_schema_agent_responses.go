...
const (
	...
	// AddQANMySQLPerfSchemaAgentOKBodyQANMysqlPerfschemaAgentStatusINITILIZATIONERROR captures enum value "INITILIZATION_ERROR"
	AddQANMySQLPerfSchemaAgentOKBodyQANMysqlPerfschemaAgentStatusINITILIZATIONERROR string = "INITILIZATION_ERROR"
)
