...
const (
	...
	// ChangeMySQLdExporterOKBodyMysqldExporterStatusINITILIZATIONERROR captures enum value "INITILIZATION_ERROR"
	ChangeMySQLdExporterOKBodyMysqldExporterStatusINITILIZATIONERROR string = "INITILIZATION_ERROR"
)
