...
const (
	...
	// AddRDSExporterOKBodyRDSExporterStatusINITILIZATIONERROR captures enum value "INITILIZATION_ERROR"
	AddRDSExporterOKBodyRDSExporterStatusINITILIZATIONERROR string = "INITILIZATION_ERROR"
)
