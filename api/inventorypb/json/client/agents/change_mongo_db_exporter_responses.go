...
const (
	...
	// ChangeMongoDBExporterOKBodyMongodbExporterStatusINITILIZATIONERROR captures enum value "INITILIZATION_ERROR"
	ChangeMongoDBExporterOKBodyMongodbExporterStatusINITILIZATIONERROR string = "INITILIZATION_ERROR"
)
