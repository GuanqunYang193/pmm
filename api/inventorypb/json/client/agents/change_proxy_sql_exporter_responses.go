...
const (
	...
	// ChangeProxySQLExporterOKBodyProxysqlExporterStatusINITILIZATIONERROR captures enum value "INITILIZATION_ERROR"
	ChangeProxySQLExporterOKBodyProxysqlExporterStatusINITILIZATIONERROR string = "INITILIZATION_ERROR"
)
