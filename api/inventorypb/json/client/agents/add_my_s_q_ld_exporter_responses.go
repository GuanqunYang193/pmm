...
const (
	...
	// AddMySQLdExporterOKBodyMysqldExporterStatusINITILIZATIONERROR captures enum value "INITILIZATION_ERROR"
	AddMySQLdExporterOKBodyMysqldExporterStatusINITILIZATIONERROR string = "INITILIZATION_ERROR"
)
