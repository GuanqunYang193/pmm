...
const (
	...
	// Status2OKBodyAgentsInfoItems0StatusINITILIZATIONERROR captures enum value "INITILIZATION_ERROR"
	Status2OKBodyAgentsInfoItems0StatusINITILIZATIONERROR string = "INITILIZATION_ERROR"
)
