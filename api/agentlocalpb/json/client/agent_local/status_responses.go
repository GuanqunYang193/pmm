...
const (
	...
	// StatusOKBodyAgentsInfoItems0StatusINITILIZATIONERROR captures enum value "INITILIZATION_ERROR"
	StatusOKBodyAgentsInfoItems0StatusINITILIZATIONERROR string = "INITILIZATION_ERROR"
)
