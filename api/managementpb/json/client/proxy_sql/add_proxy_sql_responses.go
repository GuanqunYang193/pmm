...
const (
	...
	// AddProxySQLOKBodyProxysqlExporterStatusINITILIZATIONERROR captures enum value "INITILIZATION_ERROR"
	AddProxySQLOKBodyProxysqlExporterStatusINITILIZATIONERROR string = "INITILIZATION_ERROR"
)
